    ...
    <div className="about-section-flex">
      ...
      <div className="about-quote-block">
        <div className="about-quote-inner">
          ...
          <div className="about-quote-author">L’équipe NOLI </div>
        </div>
      </div>
      {/* Bloc texte à droite */}
      <div className="about-main-block">
        <h2 className="about-title-main">À propos de NOLI </h2>
        <p className="about-main-text">
          NOLI  est le comparateur d’assurance auto de référence en Côte d’Ivoire. Notre plateforme analyse des dizaines d’assureurs pour vous proposer les meilleures garanties au meilleur prix, en toute impartialité.
        </p>
        <p className="about-main-text">
